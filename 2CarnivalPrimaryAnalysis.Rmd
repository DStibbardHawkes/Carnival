---
title: "Demand for Signalling Primary Analysis"
output: html_notebook
---

### Packages and Data ###

In this document we'll run our primary analysis and model seleciton.
...
We're also interested in the impacts of age. Younger people potentially have more to gain by showing off. As we're only interested in broad trends, rather than year-by-year changes, we've coded age as a binary variable using median age split. Let's see how it performs both on its own and alongside gender.
...
I've stripped out figure legends here to save space, but in this figure predictions for men are profided on the left left, women on the right.
...
For now, let's save our full model.
