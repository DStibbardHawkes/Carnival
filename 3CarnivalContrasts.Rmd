---
title: "Exploring The Full Model"
...
FigFull <- ps_CrGtrSrA %>%
  ...
  mutate(Gender = factor(Gender, levels = c("Male", "Female"))
         ,Game = factor(Game, levels = c("Hunt", "Forage"))
...
AllContrasts %<>%
  mutate_if(is.character, 
      str_replace_all, pattern = "Hunt", replacement = "<b style='color:#e99636'>Hunt</b>") %>%
  mutate_if(is.character, 
      str_replace_all, pattern = "Forage", replacement = "<b style='color:#3c5c33'>Forage</b>") %>%
    mutate_if(is.character, 
    ...
    mutate_if(is.character, 
      str_replace_all, pattern = "Prize0", replacement = "<b style='color:#FF0000'>No Prize</b>") %>%
    mutate_if(is.character, 
      str_replace_all, pattern = "Prize1", replacement = "<b style='color:#7d5791'>Prizes</b>") %>%
    mutate_if(is.character, 
      str_replace_all, pattern = "Pay0", replacement = "<b style='color:#fbcc04'>Free</b>") %>%
    mutate_if(is.character, 
